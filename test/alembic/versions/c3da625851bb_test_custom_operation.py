...
from rls.alembic_rls import RLSOp
...
def upgrade() -> None:
    ...
    cast(RLSOp, op).enable_rls("users")
    cast(RLSOp, op).create_policy(
        table_name="users",
    ...
    cast(RLSOp, op).enable_rls("items")
    cast(RLSOp, op).create_policy(
        table_name="items",
...
def downgrade() -> None:
    ...
    cast(RLSOp, op).disable_rls("items")
    ...
    cast(RLSOp, op).disable_rls("users")
